"""
Gemini AI Integration for Question Generation and Evaluation
...
class GeminiAnalyzer:
    def __init__(self, api_key: str, backup_api_key: str = None):
        """Initialize Gemini API with primary and optional backup key for failover"""
    ...
    def _is_quota_error(self, error: Exception) -> bool:
        ...
        quota_indicators = [
            ...
            'billing', 'limit exceeded', 'quota_exceeded'
        ]
    ...
    def evaluate_subjective_answer(self, question: Dict, candidate_answer: str) -> Dict:
        ...
        for attempt in range(max_attempts):
            try:
                ...
                print(f"   Raw response: {response.text[:200] if response else 'No response'}...")
